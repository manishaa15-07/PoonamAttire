...
//                 suggestions: {
//                     checkId: 'Ensure the product ID is correct',
//                     trySearch: 'Try searching for similar products'
//                 }
//             });
//         }
...
//                 correctFormat: 'Should be a 24-character hex string'
//             });
//         }
//         res.status(500).json({
...
// // Create product (admin only - with validation)
...
// // Update product (admin only - with better validation)
...
// // Delete product (admin only - with confirmation)
...
//             return res.status(404).json({
//                 error: 'Product not found',
//                 note: 'The product may have already been deleted'
//             });
//         }

//         if (product.isActive === false) {
//             return res.status(400).json({
//                 error: 'Product is already marked as inactive'
//             });
//         }
...
//             note: 'Product can be reactivated by updating isActive to true'
//         });
//     } catch (error) {
//         if (error.kind === 'ObjectId') {
//             return res.status(400).json({
